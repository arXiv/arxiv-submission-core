...
# Ignore this case of TeX-independent wisywig software (with the ability to use TeX fonts)
...
def check_tex_produced_pdf_from_stream(stream: IO[bytes]) -> bytes:
    ...
    # Skip fonts check when TeXmacs (TeX-independent with ability to use TeX fonts)
